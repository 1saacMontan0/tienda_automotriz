...
<body>
                    ...
                    <form method="POST" action="../../controllers/ventas/registrar.php">
                        <div class="form-grid">
                            <div>
                                ...
                                <select id="vCliente" class="form-select" name="cliente">
                            ...
                            <div>
                                ...
                                <select id="vTipoFactura" name="factura" class="form-select" required onchange="validarYCalcular()">
                                    <option value="credito fiscal">Crédito Fiscal (IVA 13%)</option>
    ...
    <script>
        ...
        // 4. Lógica de Cálculo de Total e IVA (CORREGIDA)
        function calcularTotal() {
            ...
            // Se compara contra "credito fiscal" que es el value real del select
            if (tipoFactura === "credito fiscal") {
